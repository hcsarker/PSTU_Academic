; Emu8086 program to subtract two 16-bit numbers (1234h - 0020h) and display the result
...
main proc
    ...
    sub ax, bx      ; Subtract BX from AX (AX = 1234h - 0020h = 1214h)
    ; sbb ax, 0      ; Not needed since no multi-word subtraction

    ; Convert 16-bit result in AX to ASCII and print
